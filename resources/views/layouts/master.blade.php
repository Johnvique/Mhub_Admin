...
<head>
  ...
  <title>Mtaani-Tech Hub Admin</title>
              ...
              <div class="input-group-append">
                <div class="card">
                    <div class="card-body bg-primary text-white">
                        <h5>MTAANI-TECH HUB ADMIN PANEL</h5>
                    </div>
                </div>
              </div>
            </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span><p>Copyright &copy; <script>document.write(new Date().getFullYear());</script>| <a href="{{url('http://mtaanitech-hub.co.ke')}}">
                Mtaani-Tech Hub Admin</a> |All rights reserved.</p></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
